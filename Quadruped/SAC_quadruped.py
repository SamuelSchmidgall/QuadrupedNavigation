...
from Networks.NetworkTypes.rodent_networks_torch import QNetwork, Quadruped1
...
class SAC(object):
    def __init__(self, num_inputs, action_space, args, act_space):
        ...
        self.policy = Quadruped1(num_inputs, action_space, act_space)
...
def train_sac():
    ...
    for i_episode in range(40000):
        ...
        import pickle
        with open("model_layer3_dump.pkl", "wb") as f:
            pickle.dump(agent, f)

        with open("reward_layer3_dump.pkl", "wb") as f:
