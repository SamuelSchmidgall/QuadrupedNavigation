...
#from Networks.SAC_layer1 import SAC
from Networks.Utilities.utils import soft_update, hard_update, ReplayMemory
from Networks.NetworkTypes.rodent_networks_torch import QNetwork, SpinalNetworkH2Motor



class SAC_layer3(object):
    def __init__(self, num_inputs, action_space, args, act_space):
        ...
        self.policy = SpinalNetworkH2Motor(num_inputs, action_space, act_space)
...
def train_sac():
    ...
    agent = SAC_layer3(env.observation_space.shape[0],
