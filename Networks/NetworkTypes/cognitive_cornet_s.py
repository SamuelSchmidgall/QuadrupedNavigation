...
class CognitiveMapCORblock_S(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, times=1):
        ...
        self.conv2 = nn.Conv2d(
            out_channels * self.scale, out_channels * self.scale, kernel_size=3, stride=2, padding=1, bias=False)
...
def generate_CORnet_S():
    ...
    # do a temporal convolution over past K frames
    ...
    model = nn.Sequential(OrderedDict([
        ...
        ('V2', CognitiveMapCORblock_S(64, 128, times=2)),
        ('V4', CognitiveMapCORblock_S(128, 256, times=4)),
        ('IT', CognitiveMapCORblock_S(256, 512, times=2)),
