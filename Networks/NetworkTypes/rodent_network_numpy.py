...
from Networks.Utilities.utils import *
from Networks.NetworkLibrary.network_modules_numpy import NetworkModule
...
class SpinalCPG(ESNetwork):
    ...
    def forward(self, x):
        ...
        return np.concatenate([leg1, leg2], axis=1)
...
class EvolutionaryOptimizer:
    def __init__(self, network, num_workers=4, epsilon_samples=40,
...
spinal_net = SpinalCPG(envrn.observation_space.shape[0], envrn.action_space.shape[0], action_noise_std=0.001)
es_optim = EvolutionaryOptimizer(spinal_net, environment_id=env_id, learning_rate=0.001)
